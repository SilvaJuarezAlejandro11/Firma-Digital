		...
		else
		{
			...
			try 
			{
				...
				if(respuesta)
				{
					...
					JOptionPane.showMessageDialog(this, "El documento es seguro","Respuesta",JOptionPane.INFORMATION_MESSAGE);
				}
				else
				{
					
					JOptionPane.showMessageDialog(this, "Peligro, pudo haber un cambio en el documento","Respuesta",JOptionPane.INFORMATION_MESSAGE);
